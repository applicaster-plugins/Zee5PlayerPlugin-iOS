...
-(void)getKCDNUrl:(NSString *)ContentID withCompletion:(CDNhandlerSuccess)Success andFailure:(CDNhandlerfailure)failure
{
    ...
    NSDictionary *param =@{@"c3.vr":@"2", @"c3.ck":@"28bbf0a3decf6d1165032bfd835d6e1844c5d44d",@"c3.rt":@"p",@"c3.vp":@"s",@"c3.im":@"d",@"c3.um":@"d",@"c3.r1":@"akamai",@"c3.r2":@"cloudfront",@"c3.r3":@"tata",@"c3.at":@"ON_DEMAND",@"c3.ext.VI":@"956528b0-efcd-41dd-bda4-adb1a907534f",@"c3.ext.DEVICE":@"apple_app",@"c3.ext.PROVIDER":@"shaka",@"c3.ext.contentID":ContentID
       };

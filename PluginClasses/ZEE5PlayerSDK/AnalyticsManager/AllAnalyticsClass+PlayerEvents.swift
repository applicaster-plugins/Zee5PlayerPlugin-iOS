...
public func VideoPlay(with data: NSDictionary)
{
           
    let parameter : Set = [
        Keys.VIDEO_PLAY.SOURCE ~>> notAppplicable,      // TT
        Keys.VIDEO_PLAY.VIDEO_INITIATION_METHOD ~>> notAppplicable,
        Keys.VIDEO_PLAY.CONTENT_ID ~>> contentId == "" ? notAppplicable:contentId ,
        Keys.VIDEO_PLAY.GENRE ~>> genereString  == "" ? notAppplicable : genereString,
        Keys.VIDEO_PLAY.CHARACTERS ~>> "",
        Keys.VIDEO_PLAY.PREVIEW_STATUS ~>> "",
        Keys.VIDEO_PLAY.PAGE_NAME ~>> notAppplicable,
        Keys.VIDEO_PLAY.DRM_VIDEO ~>> DrmVideo,
        Keys.VIDEO_PLAY.SUBTITLES ~>> Subtitles.count > 0 ? true : false,
        Keys.VIDEO_PLAY.CONTENT_ORIGINAL_LANGUAGE ~>> "",
        Keys.VIDEO_PLAY.AUDIO_LANGUAGE ~>> audiolanguage.count > 0 ? audiolanguage.description:notAppplicable,
        Keys.VIDEO_PLAY.SUBTITLE_LANGUAGE ~>> Subtitles.count > 0 ? Subtitles.description : notAppplicable,
        Keys.VIDEO_PLAY.TAB_NAME ~>> notAppplicable,
        Keys.VIDEO_PLAY.CAST_TO ~>> notAppplicable,
        Keys.VIDEO_PLAY.TV_CATEGORY ~>> notAppplicable,
        Keys.VIDEO_PLAY.CHANNEL_NAME ~>> notAppplicable,
        Keys.VIDEO_PLAY.CONTENT_DURATION ~>> duration == 0 ? 0:duration,
        Keys.VIDEO_PLAY.PUBLISHING_DATE ~>> realeseDate == "" ? notAppplicable:realeseDate,
        Keys.VIDEO_PLAY.SERIES ~>> series == "" ? notAppplicable:series,
        Keys.VIDEO_PLAY.TITLE ~>> contentName == "" ? notAppplicable:contentName,
        Keys.VIDEO_PLAY.EPISODE_NO ~>> episodeNumber == 0 ? 0:episodeNumber,
        Keys.VIDEO_PLAY.PLAYER_HEAD ~>> currentDuration == 0 ? 0:currentDuration,
        Keys.VIDEO_PLAY.PLAYER_NAME ~>> "Kaltura",
        Keys.VIDEO_PLAY.PLAYER_VERSION ~>> PlayerVersion == "" ? notAppplicable:PlayerVersion ,
        Keys.VIDEO_PLAY.CDN ~>> "",
        Keys.VIDEO_PLAY.DNS ~>> notAppplicable,
        Keys.VIDEO_PLAY.CAROUSAL_NAME ~>> notAppplicable,
        Keys.VIDEO_PLAY.CAROUSAL_ID ~>> notAppplicable,

    ]
      analytics.track(Events.VIDEO_PLAY, trackedProperties: parameter)
    ...
    public func AutoseekChanged(with Direction: NSString , Value:NSInteger)
    {
       ...
       // let scrubDuration = currentDuration - Double(Value)
        ...
        let parameter : Set = [
            ...
            Keys.AUTO_SEEK.CONTENT_ORIGINAL_LANGUAGE ~>> "",
            ...
            Keys.AUTO_SEEK.TV_CATEGORY ~>> notAppplicable,
    ...
    public func ReplayVideoEvent()
       {
           ...
           let parameter : Set = [
               ...
               Keys.REPLAY.CONTENT_ORIGINAL_LANGUAGE ~>> "",
               ...
               Keys.REPLAY.TV_CATEGORY ~>> notAppplicable,
    ...
    public func SkipIntoVideo(with SkipstartTime: NSString , SkipendTime:NSString)
       {
          ...
          let parameter : Set = [
           ...
           Keys.SKIP_INTRO.CONTENT_ORIGINAL_LANGUAGE ~>> "",
           ...
           Keys.SKIP_INTRO.TV_CATEGORY ~>> notAppplicable,
       ...
       public func SkipRecapVideo(with SkipstartTime: NSString , SkipendTime:NSString)
          {
             ...
             let parameter : Set = [
              ...
              Keys.SKIP_RECAP.CONTENT_ORIGINAL_LANGUAGE ~>> "",
              ...
              Keys.SKIP_RECAP.TV_CATEGORY ~>> notAppplicable,
    ...
    public func watchCredit(with creditStartTime: NSString)
       {
          ...
          let parameter : Set = [
           ...
           Keys.WATCH_CREDITS.CONTENT_ORIGINAL_LANGUAGE ~>> "",
           ...
           Keys.WATCH_CREDITS.TV_CATEGORY ~>> notAppplicable,
    ...
    public func PauseEvent()
       {
          ...
          let parameter : Set = [
           ...
           Keys.PAUSE.CONTENT_ORIGINAL_LANGUAGE ~>> "",
           ...
           Keys.PAUSE.TV_CATEGORY ~>> notAppplicable,
    ...
    public func PLayEvent()
       {
          ...
          let parameter : Set = [
           ...
           Keys.RESUME.CONTENT_ORIGINAL_LANGUAGE ~>> "",
           ...
           Keys.RESUME.TV_CATEGORY ~>> notAppplicable,
    ...
    public func Seekbar_ChangeEvent(with Direction: NSString , StartTime:NSInteger,EndTime:NSInteger)
       {
           ...
           let parameter : Set = [
               ...
               Keys.SCRUB_SLASH_SEEK.CHARACTERS ~>> "",
               ...
               Keys.SCRUB_SLASH_SEEK.CONTENT_ORIGINAL_LANGUAGE ~>> "",
               ...
               Keys.SCRUB_SLASH_SEEK.TV_CATEGORY ~>> notAppplicable,
    ...
    public func AudiochangeEvent(with Old: String , New:String,TrackingMode:String)
       {
           ...
           let parameter : Set = [
               ...
               Keys.LANGUAGE_AUDIO_CHANGE.CHARACTERS ~>> "",
               ...
               Keys.LANGUAGE_AUDIO_CHANGE.CONTENT_ORIGINAL_LANGUAGE ~>> "",
               ...
               Keys.LANGUAGE_AUDIO_CHANGE.TV_CATEGORY ~>> notAppplicable,
    ...
    public func SubtitleLangChangeEvent(with Old: String , New:String ,TrackingMode:String)
       {
           ...
           let parameter : Set = [
               ...
               Keys.SUBTITLE_LANGUAGE_CHANGE.CHARACTERS ~>> "",
               ...
               Keys.SUBTITLE_LANGUAGE_CHANGE.CONTENT_ORIGINAL_LANGUAGE ~>> "",
               ...
               Keys.SUBTITLE_LANGUAGE_CHANGE.TV_CATEGORY ~>> notAppplicable,
       ...
       public func BufferStartEvent()
          {
             ...
             let parameter : Set = [
              ...
              Keys.BUFFER_START.CONTENT_ORIGINAL_LANGUAGE ~>> "",
              ...
              Keys.BUFFER_START.TV_CATEGORY ~>> notAppplicable,
    ...
    public func BufferENDEvent(with BufferDuration: Int)
       {
          ...
          let parameter : Set = [
           ...
           Keys.BUFFER_END.CONTENT_ORIGINAL_LANGUAGE ~>> "",
           ...
           Keys.BUFFER_END.TV_CATEGORY ~>> notAppplicable,
       ...
       public func PlayerViewChanged(with Old: String , New:String )
          {
             ...
             let parameter : Set = [
              ...
              Keys.PLAYER_VIEW_CHANGED.CHARACTERS ~>> "",
              ...
              Keys.PLAYER_VIEW_CHANGED.CONTENT_ORIGINAL_LANGUAGE ~>> "",
              ...
              Keys.PLAYER_VIEW_CHANGED.TV_CATEGORY ~>> notAppplicable,
    ...
    public func VideoExit()
       {
          ...
          let parameter : Set = [
           ...
           Keys.VIDEO_EXIT.CONTENT_ORIGINAL_LANGUAGE ~>> "",
           ...
           Keys.VIDEO_EXIT.TV_CATEGORY ~>> notAppplicable,
    ...
    public func CastingStartEvent(with CastTo:String)
       {
          ...
          let parameter : Set = [
           ...
           Keys.CASTING_STARTED.CHARACTERS ~>> "",
           ...
           Keys.CASTING_STARTED.CONTENT_ORIGINAL_LANGUAGE ~>> "",
           ...
           Keys.CASTING_STARTED.TV_CATEGORY ~>> notAppplicable,
    ...
    public func CastingEndEvent(with CastTo:String)
       {
          ...
          let parameter : Set = [
           ...
           Keys.CASTING_ENDED.CONTENT_ORIGINAL_LANGUAGE ~>> "",
           ...
           Keys.CASTING_ENDED.TV_CATEGORY ~>> notAppplicable,
    ...
    public func DownloadStart(with Quality:String)
       {
          ...
          let parameter : Set = [
           ...
           Keys.DOWNLOAD_START.CHARACTERS ~>> "",
           ...
           Keys.DOWNLOAD_START.CONTENT_ORIGINAL_LANGUAGE ~>> "",
           ...
           Keys.DOWNLOAD_START.INTRO_PRESENT ~>> "",   // TT
           Keys.DOWNLOAD_START.TV_CATEGORY ~>> notAppplicable,
    ...
    public func DownloadCompleteOrFail()
       {
          ...
          let parameter : Set = [
           ...
           Keys.DOWNLOAD_RESULT.CHARACTERS ~>> "",
           ...
           Keys.DOWNLOAD_RESULT.CONTENT_ORIGINAL_LANGUAGE ~>> "",
           ...
           Keys.DOWNLOAD_RESULT.INTRO_PRESENT ~>> "",
           Keys.DOWNLOAD_RESULT.TV_CATEGORY ~>> notAppplicable,
    ...
    public func DownloadDelete(with item:DownloadItem)
       {
          ...
          let parameter : Set = [
           ...
           Keys.DOWNLOAD_DELETE.CHARACTERS ~>> "",
           ...
           Keys.DOWNLOAD_DELETE.CONTENT_ORIGINAL_LANGUAGE ~>> "",
           ...
           Keys.DOWNLOAD_DELETE.INTRO_PRESENT ~>> "",
           Keys.DOWNLOAD_DELETE.TV_CATEGORY ~>> notAppplicable,
       ...
       public func DownloadPlayClick(with item:DownloadItem)
          {
             ...
             let parameter : Set = [
              ...
              Keys.DOWNLOAD_CLICK.INTRO_PRESENT ~>> "",
